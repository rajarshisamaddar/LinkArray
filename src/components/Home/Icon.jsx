  ...
  return (
    <>
      ...
      <div
        ...
        } h-screen  top-0 left-0 right-0 bottom-0 bg-[rgba(245,247,179,0.3)]  fixed flex 
        justify-center items-center`}
      >
        <div
          className={`bg-[#fafafa] dark:bg-[#181818] h-[80%]  transition-opacity overflow-hidden ease-in-out  z-[1] w-[60%]  
